...
# The first use of the dataset, the images will be loaded from disk
...
model.fit(train_dataset, epochs=10, steps_per_epoch=math.ceil(
...
def plot_image(i, predictions_array, true_labels, images):
    ...
    plt.imshow(img[..., 0], cmap=plt.cm.get_cmap("binary"))
